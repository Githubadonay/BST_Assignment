public class TestBST {
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println("Test2: Search 80: " + e.getMessage());
        }
        ...
        try {
            ...
            System.out.println("Test3: Search 40: " + e.getMessage());
        }
        // assertTrue("Test 3: search 40: ", BST3.search(40) == 40);
        try {
            assertTrue("Test 3: search 100: ", BST3.search(100) == 100);
        } catch (IllegalStateException e) {
            System.out.println("Test3: Search 100: " + e.getMessage());
        }
        // assertTrue( "Test 3: search 100: ", BST3.search(100) == 100);
